...
def move_and_rename_images(target_dir):
    train = [r"G:\datas\ImageNet-1k\train_images_{}".format(i) for i in range(5)]
    val = [r"G:\datas\ImageNet-1k\ILSVRC2012_img_val"]
    test = [r"G:\datas\ImageNet-1k\test_images"]
    # 遍历源文件夹中的文件
    for source_dir in test:
...
def convert():
    # 指定源文件夹和目标文件夹路径
    source_directory = r'G:\datas\ImageNet-1k'  # 图片数据所在文件夹
    target_directory = r'G:\datas\ImageNet\test'  # 处理之后的文件夹
