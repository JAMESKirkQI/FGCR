...
from transformer_models.models_mae_pvt import PVTBlock, PatchMerge, PatchEmbed
...
def pvt_small(**kwargs):
    model = PVT( patch_size=4, in_chans=3,
                embed_dims=[64, 128, 320, 512], depths=[3, 4, 6, 3], num_heads=[1, 2, 5, 8],
                mlp_ratios=[8, 8, 4, 4], sr_ratios=[8, 4, 2, 1],  # [8, 4, 2, 1] for finetune
...
if __name__ == '__main__':
    ...
    model = pvt_small(img_size=256,num_classes=1000).to("cuda")
