...
import model_FGCR as models_mae
import transformer_models.models_mae_swin as swin_mae
import transformer_models.models_mae_pvt as pvt_mae
...
def get_args_parser():
    ...
    parser.add_argument('--views', default=3, type=int,
                        help='multi-views for contrastive learning and masked autoencoder.')

    parser.add_argument('--lambda_weight', default=0.1, type=float,
                        help='Loss weightage 1.')
    parser.add_argument('--sim_beta', default=0.001, type=float,
                        help='Loss weightage 2.')

    parser.add_argument('--drop_path', type=float, default=0.0, metavar='PCT',
                        help='Drop path rate (default: 0.1)')
    # msak transform with Swin and Pvt
    ...
    parser.add_argument('--mask_regular', action='store_true',
                        help='mask_regular')
    parser.set_defaults(mask_regular=True)
    ...
    parser.set_defaults(frozen_emb=False)
    ...
    parser.add_argument('--version', type=str, default='FGCR',
                        help='version')
...
def main(args):
    ...
    save_str = "dataset-{},model-{}/ep-{},bs-{},lr-{}/lambda_weight-{},sim_beta-{}/views{}".format(
    ...
    save_str += ",seed-{}".format(args.seed)
